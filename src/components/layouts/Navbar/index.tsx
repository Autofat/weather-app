...
import darkLogo from '../../../../public/logo-hitam.svg';

const Navbar = () => {
  const isClient = typeof window !== 'undefined';
  const initialTheme = isClient ? localStorage.getItem('theme') || 'light' : 'light';
  ...
  useEffect(() => {
    ...
    return (
    <div className="navbar bg-base-100 md:px-10 drop-shadow-lg">
        <div className="navbar-start gap-4">
            <div className="dropdown ease-in-out duration-300">
                <div tabIndex={0} className="lg:hidden">
                    <label className="btn btn-circle swap swap-rotate">
                        <input type="checkbox" checked={menuOpen} onChange={menuToggle} />
                        <input type="checkbox" />
